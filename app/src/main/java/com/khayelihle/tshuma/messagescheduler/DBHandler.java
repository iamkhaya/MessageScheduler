...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + MESSAGES_TABLE + "("
    ...
    public Message getMessage(int id) {
        ...
        Cursor cursor = db.query(MESSAGES_TABLE, new String[]{KEY_ID,
                        KEY_CONTENT, KEY_CATEGORY}, KEY_ID + "=?",
    ...
    public List<Message> getAllMessages() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                msg.setCategory(cursor.getString(2));
    ...
    public void deleteMessage(Message msg) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(MESSAGES_TABLE, KEY_ID + " = ?",
                    new String[] { String.valueOf(msg.getId()) });
        db.close();
    }
}
